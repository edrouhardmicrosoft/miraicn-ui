...
description: Using miraicn/ui with Next.js 15 and React 19.
---
...
If you're using `npm`, you can install miraicn/ui dependencies with a flag. The `shadcn` CLI will prompt you to select a flag when you run it. No flags required for pnpm, bun, or yarn.
...
## Using miraicn/ui on Next.js 15

### Using pnpm, bun, or yarn

Follow the instructions in the [installation guide](/docs/installation/next) to install miraicn/ui. No flags are needed.
...
To make it easy for you track the progress of the upgrade, I've created a table below with React 19 support status for the miraicn/ui dependencies.
