---
title: Tailwind v4
description: How to use miraicn/ui with Tailwind v4 and React 19.
---
...
One of the major advantages of using `miraicn/ui` is that the code you end up with is exactly what you'd write yourself. There are no hidden abstractions.
