---
title: Monorepo
description: Using miraicn/ui components and CLI in a monorepo.
---

Until now, using miraicn/ui in a monorepo was a bit of a pain. You could add
